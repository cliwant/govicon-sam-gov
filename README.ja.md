...
> **ステータス:** Archived — コードは [cliwant/mcp-sam-gov](https://github.com/cliwant/mcp-sam-gov) に統合。

`@govicon/sam-gov` スタンドアロンライブラリは **[`@cliwant/mcp-sam-gov`](https://github.com/cliwant/mcp-sam-gov) に統合**されました。すべての federal-data 作業の正式 home:
